...
def main():
	...
	f.write("""\t\tSL\t\tsurveyls_survey_id\t\t180199\t\tit\n""")
	...
	with open('configuration.csv', 'r') as file:
		...
		for row in reader:
			if(line_count != 0):
				...
				f.write("""%d\t\tG\t%d\t"Paziente No. %d ~ Pagina 1"\t1\t"Di seguito potra' visionare una breve descrizione del paziente ID-%d e l'immagine relativa al suo ECG. Le osservi con attenzione e infine risponda alla domanda in fondo alla pagina. <br /> NB: Se lo reputa necessario, passando il puntatore del mouse sulla figura si attivera' uno zoom che le consentira' di leggere al meglio le strutture evidenziate. Se il suo browser non dovesse consentire la corretta visualizzazione delle immagini, prema il tasto destro sulla figura -> 'Apri immagine in una nuova scheda'."\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (4*i+1,4*i+1,i,i))
				#f.write("""%d\t\tQ\tX\timage%d1\t1\t"<style text=""text/css"">.zoom { padding: 50px; background-color: white; transition: transform .2s; width: 20px; height: 20px; margin: 0 ;} .zoom:hover { transform: scale(1.3);} </style><p style=""text-align:center;""><img alt=""ECG paziente %d"" class=""zoom"" src=""%s"" style=""height: 750px; width: 1100px;""></p>"\t\tit\t\tN\tN\t\t0\n""" % (100*i+1,i,i,case_image_url))
				...
				f.write("""%d\t\tQ\tT\ttext1%d\t1\t"Alla luce del tracciato del paziente ID-%d, prego ci fornisca la sua diagnosi: "\t"Se non e' sicuro della sua scelta, avra' modo di modificarla nelle domande successive."\tit\t\tY\tN\t\t0\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (100*i+3,i,i))
				
				f.write("""%d\t\tG\t%d\t"Paziente No. %d ~ Pagina 2"\t1\t"Di seguito potra' visionare la descrizione, l'ECG e la diagnosi suggerita dall'AI del paziente ID-%d. Legga con attenzione e risponda alla domanda. "\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (4*i+2,4*i+2,i,i))
				...
				f.write("""%d\t\tQ\tL\tlabel1%d\t1\t"Dopo aver visionato la diagnosi prodottta dall'AI, quale e' la sua scelta? "\t"Se desidera modificare la sua precedente diagnosi e inserirne una nuova, utilizzi il box sottostante."\tit\t\tY\tN\t\t0\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (100*i+7,i))				
				f.write("""%d\t\tA\t0\t0\t\t"Confermo la mia diagnosi: <br/> <p style=""color: rgb(60,92,126)"">{list(that.text1%d.shown)}"<p/>\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t0\n""" % (100*i+7,i))
				f.write("""%d\t\tA\t0\t1\t\t"Scelgo la diagnosi prodotta dall'AI"\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t0\n""" % (100*i+7))
				f.write("""%d\t\tA\t0\t2\t\t"Inserisco una nuova diagnosi..."\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t0\n""" % (100*i+7))
				f.write("""%d\t\tQ\tT\ttext2%d\t"(((!is_empty(label1%d.NAOK) && (label1%d.NAOK == 2))))"\t"Inserisca la sua nuova diagnosi: "\t\tit\t\tY\tN\t\t0\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (100*i+8,i,i,i))
				f.write("""%d\t%d\tC\t1\tlabel1%d\t'==\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (100*i+9,100*i+7,i)) 
								
				f.write("""%d\t\tG\t%d\t"Paziente No. %d ~ Pagina 3"\t1\t"Di seguito potra' visionare tutte le informazioni delle pagine precedenti e la spiegazione testuale prodotta dall'AI del paziente ID-%d. Legga con attenzione e risponda alla domanda. <br />"\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (4*i+3,4*i+3,i,i))
				...
				f.write("""%d\t\tQ\tL\tlabel2%d\t1\t"Dopo aver visionato la spiegazione testuale prodotta dall'AI, ha cambiato idea relativamente alla diagnosi da lei ideata in precedenza? "\t"Se desidera modificare la sua precedente diagnosi e inserirne una nuova, utilizzi il box sottostante. "\tit\t\tY\tN\t\t0\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (100*i+14,i))		
				f.write("""%d\t\tA\t0\t0\t\t"Confermo la mia diagnosi: <br/><p style=""color: rgb(60,92,126)"">{if(!is_empty(text2%d),list(that.text2%d.shown),list(that.text1%d.shown))}"<p/>\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t100\n""" % (100*i+14,i,i,i))
				...
				f.write("""%d\t\tG\t%d\t"Paziente No. %d ~ Pagina 4"\t1\t"Di seguito potra' visionare una tabella in cui indicare, tramite un valore da 1 a 6, tre dimensioni di qualita' della spiegazione fornita dall'AI. <br />Per semplicita' sono riportati la descrizione, l'ECG, la diagnosi e la spiegazione fornita nei box sottostanti. <br />"\t\tit\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n""" % (4*i+4, 4*i+4,i))		
